...
# FIX: guard the strptime call; log a warning (with order id for observability)
#   and fall back to 0 ETA days so the quote can still be returned.
            ...
            json.dumps(
                {
                    ...
                    "message": "Malformed deliveryDate; falling back to etaDays=0",
                }
            )
        )
        return 0
